    ...
    <div>
      <section className="px-5 md:px-10 py-14 md:py-20 bg-paper-soft text-center">
        <div className="max-w-2xl mx-auto">
          <div className="text-[12px] font-medium mb-3 tracking-[0.2em] uppercase text-gold-deep">Contact</div>
          <h1 className="font-display text-3xl md:text-5xl text-navy mb-5">Get in Touch</h1>
          <p className="text-[16px] text-ink-muted leading-relaxed">
            Reach our desk directly, or submit a service request and we&apos;ll follow up right away.
          </p>
        </div>
      </section>
          ...
          {contacts.map((c, i) => (
            <Reveal key={c.id} delay={i * 0.08}>
              <div className="rounded-2xl border border-border bg-white p-6 shadow-card h-full">
                <div className="text-navy font-medium mb-3">{c.label}</div>
