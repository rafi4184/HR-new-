  ...
  return (
    <section className="px-5 md:px-10 py-16 md:py-20 max-w-3xl mx-auto">
      <Reveal className="text-center mb-10">
        <div className="text-[12px] font-medium mb-3 tracking-[0.2em] uppercase text-gold-deep">{eyebrow}</div>
        <h2 className="font-display text-3xl md:text-4xl text-navy">{title}</h2>
      </Reveal>
